<?php if (get_field('mostrar_bloque')): ?>
    ...
    <section id="<?= preg_replace('/\s+/', '',get_field('id_ancla')) ?>" class="block-team">

        <div class="container">
            <div class="block-team__inner">
                                    ...
                                    <div class="member__inner">
                                        ...
                                        <div class="member__details">
                                            ...
                                            <ul class="social-networks">
                                                <?php $redes = get_sub_field('redes_sociales') ?>
                                                <?php if ($redes["linkedin_url"]): ?>
                                                    <li>
                                                        <a href="<?= $redes["linkedin_url"] ?>">
                                                ...
                                                <?php endif ?>
                                                <?php if ($redes["twitterx_url"]): ?>
                                                    <li>
                                                        <a href="<?= $redes["twitterx_url"] ?>">
                                                ...
                                                <?php endif ?>
                                                <?php if ($redes["facebook_url"]): ?>
                                                    <li>
                                                        <a href="<?= $redes["facebook_url"] ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                ...
                                                <?php endif ?>
                                                <?php if ($redes["instagram_url"]): ?>
                                                    <li>
                                                        <a href="<?= $redes["instagram_url"] ?>">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                ...
                                                <?php endif ?>
                                                <?php if ($redes["youtube_url"]): ?>
                                                    <li>
                                                        <a href="<?= $redes["youtube_url"] ?>">
